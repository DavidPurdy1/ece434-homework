...
SAMPLE_SPREADSHEET_ID = '13GeS9PyN5yZr8XwM7GGx0iN5WrqnletlRvIIdCEQBhM'
...
def main():
    ...
    # Store temps in an array to be logged to the sheet
    temp = [0, 0, 0]
    while True:
      # Collect temps from the sensors and store them in the array
